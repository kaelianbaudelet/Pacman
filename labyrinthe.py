...
class Lab:
    ...
    def __init__(self, l: list):
        ...
        # On copie la grille pour pouvoir la modifier sans modifier l'originale
        # lorsqu'il faudra la réinitialiser
        for ligne in l:
    ...
    def affiche(self):
        ...
        for i in range(len(self.grille)):
            for j in range(len(self.grille[0])):
                # On affiche les éléments du labyrinthe en fonction de leur
                ...
                if self.grille[i][j] == 1:
                    ...
                    # Powergum (super gomme)
                    pyxel.blt(j * 8, i * 8, 0, 0, 16, 8, 8, 0)
                elif self.grille[i][j] == 4:
                    # Porte de sortie de la cage des fantômes
                    pyxel.rect(j * 8 + 3, i * 8 + 1, 2, 6, 7)
